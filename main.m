...
for i = ['1', '2', '3']  % Cada caso da simulacao
    ...
    if i == '1', plot_denoiser_ex(t_luenberger, y_luenberger, y_hat_luenberger, b_filter, a_filter, [0 16 -3.5E-3 3.5E-3], true, './figs/filtering_ex1.png', './figs/filtering_ex2.png'); end  % So na primeira execuçao  
